...
import "./EmployerMyChat.css";
import ChatAvatar from "./ChatAvatar";
import axios from "axios";
import { AppContext } from "../../../context/AppContexts";

function EmployerMyChat({ socket, selectedC, searchchat }) {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.length !== 0) {
          ...
          //
          JSON.parse(JSON.stringify(response.data)).some((e) => {
